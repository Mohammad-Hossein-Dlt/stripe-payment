...
from routes.api_v1.get_object._router import router as get_object_router
from routes.api_v1.management._router import router as management_router
from routes.api_v1.payment._router import router as payment_router
